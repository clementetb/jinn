...
class Bid():
    ...
    def __init__(self, domain=None, values=dict):
        self.domain = domain
        self.values = values
        self.id = Bid.INSTANCES
        Bid.INSTANCES += 1

    def get_discrete_issue_function(self, issue):
        names = []
        values = []
    ...
    def get_real_issue_function(self, issue, resolution):
    ...
    def get_issue_function(self, issue, resolution):
        values = None
        steps = None
    ...
    def get_utility_function(self, template, resolution):
        asteps = []
        avalues = []
    ...
    def generate_bids(self, template1, template2, resolution):
